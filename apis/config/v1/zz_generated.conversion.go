...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddConversionFunc((*RankBasedSortingArgs)(nil), (*config.RankBasedSortingArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_RankBasedSortingArgs_To_config_RankBasedSortingArgs(a.(*RankBasedSortingArgs), b.(*config.RankBasedSortingArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddConversionFunc((*TopologyAwareVolumeAllocationArgs)(nil), (*config.TopologyAwareVolumeAllocationArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_TopologyAwareVolumeAllocationArgs_To_config_TopologyAwareVolumeAllocationArgs(a.(*TopologyAwareVolumeAllocationArgs), b.(*config.TopologyAwareVolumeAllocationArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_RankBasedSortingArgs_To_config_RankBasedSortingArgs(in *RankBasedSortingArgs, out *config.RankBasedSortingArgs, s conversion.Scope) error {
	return nil
}

func autoConvert_v1_TopologyAwareVolumeAllocationArgs_To_config_TopologyAwareVolumeAllocationArgs(in *TopologyAwareVolumeAllocationArgs, out *config.TopologyAwareVolumeAllocationArgs, s conversion.Scope) error {
	return nil
}
...
func Convert_v1_RankBasedSortingArgs_To_config_RankBasedSortingArgs(in *RankBasedSortingArgs, out *config.RankBasedSortingArgs, s conversion.Scope) error {
	return autoConvert_v1_RankBasedSortingArgs_To_config_RankBasedSortingArgs(in, out, s)
}

func Convert_v1_TopologyAwareVolumeAllocationArgs_To_config_TopologyAwareVolumeAllocationArgs(in *TopologyAwareVolumeAllocationArgs, out *config.TopologyAwareVolumeAllocationArgs, s conversion.Scope) error {
	return autoConvert_v1_TopologyAwareVolumeAllocationArgs_To_config_TopologyAwareVolumeAllocationArgs(in, out, s)
}
